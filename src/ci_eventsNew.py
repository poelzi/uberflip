...
##Alarm countdown
clockScreenLabels["alarmCountdown"] = ci_labels.textLabel(Rect(233,402, 55, 114), "", "ci_alarm.getCountdown()")
...
clockScreenLabels["alarmCountdown"].setEnableCondition("ci_alarm.hasNextAlarm()", 1)
...
##Alarm time label (alarmOn)
clockNightScreenLabels["alarmTimeOn"] = ci_labels.textLabel(Rect(87, 400, 114, 55), "", "ci_alarm.getNextAlarmTimeString()")
clockNightScreenLabels["alarmTimeOn"].setColour((ci.mr, ci.mg, ci.mb))
clockNightScreenLabels["alarmTimeOn"].setEnableCondition("ci_alarm.hasNextAlarm()", 1)

##Alarm on helpers
clockNightScreenLabels["alarmEngaged"] = ci_labels.textLabel(Rect(114, 389, 114, 55), "", "ci_alarm.getNextAlarmDayString()")
...
clockNightScreenLabels["alarmEngaged"].setEnableCondition("ci_alarm.hasNextAlarm()", 1)
...
clockNightScreenLabels["alarmEngaged2"].setEnableCondition("ci_alarm.hasNextAlarm()", 1)

##Alarm countdown
clockNightScreenLabels["alarmCountdown"] = ci_labels.textLabel(Rect(233,402, 55, 114), "", "ci_alarm.getCountdown()")
clockNightScreenLabels["alarmCountdown"].setAngle(90)
clockNightScreenLabels["alarmCountdown"].setFont(ci.flipFonts["small"])
clockNightScreenLabels["alarmCountdown"].setColour((ci.mr, ci.mg, ci.mb))
clockNightScreenLabels["alarmCountdown"].setEnableCondition("ci_alarm.hasNextAlarm()", 1)
