...
clockScreenLabels["alarmTime"] = ci_labels.textLabel(Rect(87, 400, 114, 55), "", "ci_config.alarms[ci.thisDay][\"alarm_hhmm\"][0:2] + \":\" + ci_config.alarms[ci.thisDay][\"alarm_hhmm\"][2:4]")
clockScreenLabels["alarmTime"].setColour((110, 110, 110))
clockScreenLabels["alarmTime"].setEnableCondition("ci_config.alarms[ci.thisDay][\"enabled\"]", 0)

##Alarm time label (alarmOn)
clockScreenLabels["alarmTimeOn"] = ci_labels.textLabel(Rect(87, 400, 114, 55), "", "ci_config.alarms[ci.thisDay][\"alarm_hhmm\"][0:2] + \":\" + ci_config.alarms[ci.thisDay][\"alarm_hhmm\"][2:4]")
clockScreenLabels["alarmTimeOn"].setColour((ci.mr, ci.mg, ci.mb))
clockScreenLabels["alarmTimeOn"].setEnableCondition("ci_config.alarms[ci.thisDay][\"enabled\"]", 1)

##Alarm on helpers
clockScreenLabels["alarmEngaged"] = ci_labels.textLabel(Rect(114, 389, 114, 55), "ALARM")
clockScreenLabels["alarmEngaged"].setColour((ci.mr, ci.mg, ci.mb))
clockScreenLabels["alarmEngaged"].setFont(ci.flipFonts["small"])
clockScreenLabels["alarmEngaged"].setEnableCondition("ci_config.alarms[ci.thisDay][\"enabled\"]", 1)
...
clockScreenLabels["alarmEngaged2"].setEnableCondition("ci_config.alarms[ci.thisDay][\"enabled\"]", 1)
